...
class MATERIAL_EXPORT QtMaterialFloatingActionButtonPrivate : public QtMaterialRaisedButtonPrivate
{
...
public:
	enum
	{
		DefaultDiameter = 56, MiniDiameter = 40
	};
	
	enum
	{
		DefaultIconSize = 24, MiniIconSize = 18
	};
