...
class MATERIAL_EXPORT  QtMaterialTabsInkBar : public QtMaterialOverlayWidget
{
Q_OBJECT
...
private:
	...
	TabsInkBarDirection direction = TabsInkBarDirection::Left;
	int TabsInkBarWidth = 4;
...
class MATERIAL_EXPORT  QtMaterialTab : public QtMaterialFlatButton
{
Q_OBJECT
