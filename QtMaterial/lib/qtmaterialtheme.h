...
namespace Material
{
	enum ButtonPreset
	{
		FlatPreset, CheckablePreset
	};
	
	enum RippleStyle
	{
		CenteredRipple, PositionedRipple, NoRipple
	};
	
	enum OverlayStyle
	{
		NoOverlay, TintedOverlay, GrayOverlay
	};
	...
	enum AvatarType
	{
		ImageAvatar, IconAvatar, LetterAvatar
	};
...
class MATERIAL_EXPORT QtMaterialTheme : public QObject
{
Q_OBJECT
