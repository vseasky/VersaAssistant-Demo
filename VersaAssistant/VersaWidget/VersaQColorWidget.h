 ...
 * @FilePath     : \VersaAssistant\VersaWidget\VersaQColorWidget.h
 * @Description  : 
 */


#ifndef VERSA_ASSISTANT_VERSAQCOLORWIDGET_H
#define VERSA_ASSISTANT_VERSAQCOLORWIDGET_H
...
static const QColor paletteQColor[] = {
...
class VersaQColorWidget : public QWidget
{
Q_OBJECT
public:
	VersaQColorWidget(QWidget *parent = nullptr);
	~VersaQColorWidget();
private:
...
#endif //VERSA_ASSISTANT_VERSAQCOLORWIDGET_H
