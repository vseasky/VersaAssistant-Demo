 ...
 * @FilePath     : \VersaAssistant\Frameless\QDrawShadowHelper.cpp
 * @Description  : 
 */
#include <QVBoxLayout>
#include <QPainter>
...
QDrawShadowHelper::QDrawShadowHelper(QWidget *w, int shadowSize, QObject *parent)
		: QObject(parent), m_shadowSize(shadowSize), m_clientBorderColor(QColor("#C9C9C9")), m_widget(w), m_show(true)
{
