    ...
    ui(new Ui::MainWindow)
{
    ...
    ads::CDockWidget* VersaDockWidget = new ads::CDockWidget("Label 1");
    VersaDockWidget->setWidget(l);
    ...
    ui->menuView->addAction(VersaDockWidget->toggleViewAction());

    // Add the dock frameLessWidget to the top dock frameLessWidget area
    m_DockManager->addDockWidget(ads::TopDockWidgetArea, VersaDockWidget);
}
...
mobile nameDevices, automotive ECUs, IoT electronics. Ramses was initially developed
